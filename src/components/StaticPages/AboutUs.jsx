...
const AboutUs = () => {
  ...
  const { data: pageSettingsData = [] } = useQuery({
      ...
      <section className="about-us my-12 container mx-auto min-h-[50vh]">
        ...
        */}
        {pageSettingsData?.translated_about_us || pageSettingsData?.about_us ? (
          <RichTextContent content={pageSettingsData?.translated_about_us ? pageSettingsData?.translated_about_us : pageSettingsData?.about_us} />
        ) : (
