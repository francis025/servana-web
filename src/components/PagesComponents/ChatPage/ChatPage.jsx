        ...
        if (isImageFile(file)) {
            return (
                <div key={index} className="file-card image-card relative flex flex-col gap-2 justify-center items-center border border-gray-300 rounded-sm p-1 card_bg">
                    <CustomImageTag src={URL.createObjectURL(file)} alt={file.name} className='w-[160px] aspect-blog-related' />
                    <span>{file.name}</span>
                ...
                <div className='flex items-center justify-end gap-2 flex-wrap w-[70%] mb-1'>
                    ...
                    })}
                    {
                        ...
                        <div className='relative'>
                            ...
                            <CustomImageTag src={imageFiles[5]} alt={imageFiles[5].name} className='w-[160px] aspect-blog-related' />
                        </div>
                    }
                </div>
            </>
